...
{
    [CreateAssetMenu(fileName = "PlayerInput", menuName = "SO/PlayerInput_9", order = 0)]
    public class PlayerInputSO_9 : ScriptableObject, Controls_9.IPlayerActions
    {
